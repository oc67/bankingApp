...
#             #Getting name of budget sender:
#             budget_sender=budget.budget_owner
#             print("Budget sender's name is",budget_sender.name)
#             #Changing ownership of budget to transfer the budget:
#             budget.budget_owner=new_owner
            
#             budget.save()

#             #Add a transfer notification on the sender's notification menu:
...
#             #Add a transfer notification on the recipient's notification menu:
#             transfer_notification=Notifications.objects.create(
#                         notification_text="Budget for %s %d has been received from %s"%(requested_month,
#                                                                            requested_year,
#                                                                            budget_sender.name,
#                                                                            ),
#                         notification_time=datetime.now(),
#                         notification_viewer=budget.budget_owner)            
...
#         #sorted_queryset=
#         print("filter output is ",
#               AuditTrail.objects.filter(budget__budget_ID=budget_ID, budget__budget_owner=self.request.user).order_by("-action_time"))
#         return AuditTrail.objects.filter(budget__budget_ID=budget_ID, budget__budget_owner=self.request.user).order_by("-action_time")
